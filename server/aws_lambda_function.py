...
def lambda_handler(event, context):
    ...
    topics = ["Business Overview", "Market Analysis", "Competitive Advantage", "Sales & Market Strategy", "Timeline",
              "Finance", "Key Metrics and Risk Deduction", "Conclusion"]
    # topics  = ["Conclusion"]
    ...
    prompts = [
        ...
        f"summarize the following text in 150 words. Make it a conclusion for a business plan. {summary}"]
